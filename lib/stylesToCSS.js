...
function replicateSelector(selector) {
  return [
    selector,
    [selector, selector + 1].join(''),
    [selector, selector + 1, selector + 2].join(''),
    [selector, selector + 1, selector + 2, selector + 3].join(''),
    [selector, selector + 1, selector + 2, selector + 3, selector + 4].join('')
  ].join(',');
}
